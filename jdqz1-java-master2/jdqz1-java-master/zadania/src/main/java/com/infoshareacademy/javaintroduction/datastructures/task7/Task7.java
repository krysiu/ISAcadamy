...
public class Task7 {
    ...
    public static void main(String[] args) {
        ...
        //Person longestUsername = UserService.findUserWithLongestUsername(users);
        //System.out.println(longestUsername);

        //String getNameAndSurnameAbove18 = UserService.getNamesAndSurnamesCommaSeparatedOfAllUsersAbove18(users);
        //System.out.println(getNameAndSurnameAbove18);

        TreeSet getSortedPermissions = UserService.getSortedPermissionsOfUsersWithNameStartingWithA(users);;
        System.out.println(getSortedPermissions);
